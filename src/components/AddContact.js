...
function AddContact (props){
    ...
    <input type="text" className="inputField" id="name" placeholder="Full Name" onChange={(e)=>{contact.name=e.target.value}}/>
    </div>
    
<div className="inputContainer">
<FontAwesomeIcon icon={faPhone} className='inputIcon'/>
    <input type="numeric" className="inputField" id="phone" placeholder="Phone Number" onChange={(e)=>{contact.phoneNumber=e.target.value}}/>
</div>
<div className="inputContainer">
<FontAwesomeIcon icon={faEnvelope} className='inputIcon'/>
    <input type="numeric" className="inputField" id="email" placeholder="Email Address" onChange={(e)=>{contact.emailAddress=e.target.value}}/>
</div>
